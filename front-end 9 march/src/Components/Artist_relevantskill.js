...
export class Artist_relevantskill extends Component {
  render() {
    return (
      <div>
 ...
 <nav className="navbar bg-light fixed-top" style={{backgroundColor: 'white'}}>
    ...
    <div className="patron-search-artist">
            ...
            <div className="row">
                <div className="col">
                    ...
                    <div className="search-data-text text-center">
                        Search result for
                        <strong className="search-data-text-category">Training</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="patron-search-artist-body container">
            ...
            <div className="card artist-card">
                <div className="card-body">
                    <div style={{marginLeft:"7px"}} className="row patron-search-artist-body-header">
                        <div className="col artist-name">
                          Training1
                        </div>
                        <div className="w-100"></div>
...
export default Artist_relevantskill
