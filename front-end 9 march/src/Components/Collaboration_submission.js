...
import './Artist.css'
export class Collaboration_submission extends Component {
  render() {
    return (
      <div>
    ...
    <div className="card border-primary mb-3 " style={{height: "40vh", width: "50rem"}}>
        <div className="card-header fw-bold p-5 fs-4" style={{textAlign: "center"}}>
...
export default Collaboration_submission
