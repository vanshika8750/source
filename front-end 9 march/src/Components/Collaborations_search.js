import { Link } from 'react-router-dom'
  ...
  import './css_new.css'
  export default function Collaborations_search() {
  return (
  <div>
    {/* Modal */}
        ...
        <div className="row">
          <div className="col">
            ...
            <div className="search-data-text text-center">
              <strong className="search-data-text-category">Collaborations</strong>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="card-body">
            <div style={{marginLeft:"5px"}} className="row patron-search-artist-body-header">
              ...
              <div className="col artist-category collab_margin_below">
                ...
                <span className='date_collab_search'>Date:22/11/22</span>
              </div>
            </div>
