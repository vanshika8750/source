...
export default class SS_upload_opportunities extends Component {
  render() {
    return (
      <div>
          ...
          <div className="card-body">
              <form action="uploaded-opportunities.html" onsubmit="return(validateEditOpportunity());">
                  <div className="mb-3 row">
                      <label for="position"
                          className="col-sm-2 col-form-label patron-upload-opportunity-form-label-small-input-box fs-4" ><strong>Course : </strong></label>
                      <div className="col-sm-10">
                          <input type="text" className="form-control patron-upload-opportunity-inputPosition    mt-2 align-left"
                              id="position"  />
                      </div>
                      <div className="mb-3">
                      <label for="Requirements"
                          className="form-label patron-upload-opportunity-form-label fs-4  " ><strong>About Course :</strong></label>
                      <textarea className="form-control" id="requirements" rows="3"  ></textarea>
                  </div>
                  </div>
                  <div className="mb-3">
                      <label for="aboutCompany" className="form-label patron-upload-opportunity-form-label fs-4" ><strong>About
                          Agency :</strong></label>
                      <textarea className="form-control" id="aboutCompany" rows="3"  ></textarea>
                  </div>
                  <div className="mb-3">
                      <label for="Requirements"
                          className="form-label patron-upload-opportunity-form-label fs-4" ><strong>Requirements :</strong></label>
                      <textarea className="form-control" id="requirements" rows="3"  ></textarea>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    {/* <button type="button" class=" btn btn-danger float-right m-3 " style={{maxWidth:"200px"}}> */}
                        <Link to="/SS_View_uploaded_opportunities" className="btn btn-danger me-md-2 btn-new float-right" type="submit" value="Submit">
                          Save changes
                       </Link>  
                        {/* </button> */}
              </form>
