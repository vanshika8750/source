...
export default function View_artist_detail() {
  ...
  const handleShortlist = async () => {
    ...
    let storeshortlist = await fetch(
      `http://localhost:4000/api/user/shortlist/opportunity/${oppoid}/${artistid}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    <div>
      ...
      {/* <div className="view-artist">
        <div className="view-artist-header">
          <div className="view-artist-top-text">
            <div className="text-center">Artist Profile</div>
          </div>
        </div>
            ...
            >
              <div style={{ marginLeft: "10px" }} className="card-body">
                <div className="card-body-content">
                  ...
                  <div className="row">
                    <div className="col view-artist-info-title">Skills</div>
                    <div className="w-100"></div>
                    <div className="col view-artist-info-body"></div>
                  </div>
                  <div className="row">
      ...
      <div className="view_profile">
        ...
        <div className="view_upper_profile">
          ...
          <div>
            <div className="view_profile_name">
              {artist?.name} {artist?.middlename} {artist?.lastname}
            </div>
            <div className="view_profile_position">
              {employerData?.position}
            </div>
            <div className="view_profile_location">
        ...
        <div className="view_lower_profile">
          <table className="view_profile_detail">
            <tr>
              <td>age: </td>
              <td>{artist?.artist?.age}</td>
            </tr>
            <tr>
              <td>Education: </td>
              <td>{artist?.artist?.education}</td>
            </tr>
            <tr>
              <td>Experience: </td>
              <td>{artist?.artist?.experince}</td>
            </tr>
            <tr>
              <td>Language: </td>
              <td>{artist?.artist?.language}</td>
            </tr>
            <tr>
              <td>Height: </td>
              <td>{artist?.artist?.height}</td>
            </tr>
          </table>
          ...
          <div className="view_profile_btn">
            <button className="hire" onClick={handleHire}>
              Hire
            </button>
            <button className="shortlist" onClick={handleShortlist}>
              shortlist Kalakaar
            </button>
