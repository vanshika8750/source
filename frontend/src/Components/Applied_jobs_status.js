...
export class Applied_jobs_status extends Component {
  render() {
    return (
      <div>
            ...
            <div className="card artist-card">
                <div className="card-body">
                    <div style={{marginLeft:"8px"}} className="row patron-search-artist-body-header">
                        ...
                        <div className="status-artist col-auto" style={{color:" darkorange",fontSize: "large",fontStyle: "italic",right:"0px"}}>
                            In Touch
                        </div>
                        <div className="w-100"></div>
                        <div className="col artist-category">
...
export default Applied_jobs_status
