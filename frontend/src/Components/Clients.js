...
<div class='container'>
    ...
    <div id="portfolio" class="gallery">
        ...
        <div class="gallery_product col-lg-2 col-md-3 col-sm-4 col-6 ">
        ...
        <div class="container">
            <div class="col-md-12">
                <div class="section-header text-center pb-5">
                    ...
                    "Let's take most of the money we would've spent on paid advertising and paid marketing and instead of spending it on that, invest it in the customer experience/customer service and 
                ...
                <div class="col-lg-12 col-md-12 col-12 ps-lg-5 mt-md-4 text-start">
                    <div class="about-text">
                        <h2>
                            ...
                            <span class="text-danger">"It comes down to how your customer experiences the brand – and how that brand makes a person feel."  </span><br/>

                        </h2>
                        <p class="h5" style={{"margin-top": "10px" }}> 
                        On those days — which somehow often end up being Mondays and Tuesdays — it can be hard to find the motivation to prioritize customer satisfaction. 
                        You're human, and that means that you're allowed to have a bad day, here and there. However, suffering through a moody workday can make eight hours feel like 20.
                   During those gloomy shifts, sometimes, all you need is some words of wisdom and inspiration to remind you why you do what you do. After all,
                    a happy employee makes for a happier customer and, overall, a more positive interaction.
                            </p>
                        <p class="h5">
     ...
     <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-12 ps-lg-5 md-4 text-start">
                    <div class="about-text">
                        ...
                        <p class="h5" style={{"margin-top": "10px" }}> 
                 Clients can create and customize their profiles to provide information about their preferences and needs.
 Clients can easily schedule appointments with their service providers and receive automated reminders.
 Clients can pay for services online, eliminating the need for cash or checks.
 Clients can leave reviews and ratings for their service providers, helping other clients make informed decisions.
 Clients can securely message their service providers to ask questions and provide feedback.
 Clients can securely share files with their service providers, such as documents and photos.
                            </p><br/>
                        <p class="h5">
                    Clients can access detailed analytics about their service providers, such as appointment history and customer satisfaction ratings.
 Clients can join loyalty programs to earn rewards and discounts for their repeat business.
Clients can book appointments online, eliminating the need to call or visit the office.
 Clients can access their accounts and book appointments from their mobile devices.

</p>
<br/>
<p class="h5">
 The role of clients in using a client management system is to provide information about their preferences and needs, schedule appointments, pay for services, leave reviews, securely message and share files with their service providers, access analytics, join loyalty programs, book appointments online, and access their accounts from their mobile devices.

The benefits of using a client management system for clients include:
<ul>
<li> Increased convenience: Clients can access their accounts from anywhere, anytime, and book appointments online.
</li>
<li>
• Improved communication: Clients can securely message and share files with their service providers.
</li>
<li>
• Increased security: Clients can access their accounts with a secure login and password.
</li>
<li>
• Improved loyalty: Clients can join loyalty programs and earn rewards for their loyalty.
</li>
<li>
• Increased visibility: Clients can access analytics and view their past appointments and payments.</li>
</ul>
                        </p>
                ...
                <div class='section'>
                    ...
                    <div class="links_useful">
                        <div class="col">
                            ...
                            <div><a href="#">Performing Art</a></div>
                            <div><a href="#">Join Us</a></div>
                            <div><a href="#">Contact Us</a></div>
                        </div>
                        <div class="col">
                        <div><a href="#">About</a></div>
                        <div><a href="#">Opportunities</a></div>
                        <div><a href="#">Media</a></div>
                        <div><a href="#">Customer Care Services</a></div>
                        </div>
                    </div>
                </div>
                <div class="section">
