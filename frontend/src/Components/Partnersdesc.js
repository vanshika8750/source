                  ...
                  <div class="about-content">
                    <h2><span class="text-danger h2"><strong>Who are We</strong> </span>
                        ...
                        <p class="h5" style={{"margin-top": "20px"}}>
                            An individual or institutions like Music Skill Development Institute, Content Development Company, Musical instrument sellers etc.
                            Partners in Art is a not-for-profit which promotes and funds contemporary art  and whose 
                            volunteer members value education and collaboration.
                            Arts partnerships offer companies effective and cost-efficient methods of achieving critical business goals. 
                            To explore and illustrate the different types of benefits that arts partnerships can bring to businesses.
                            Mission is to build recognition and support for the extraordinary and dynamic value of the arts and to lead, serve,
                             and advance the diverse networks of organizations and individuals who cultivate the arts in India.
    Connecting your best ideas and leaders from the arts, communities, and business, together we can work to
     ensure that every indian has access to the transformative power of the arts.
     ...
     <br/>
                          <br/>
                            ...
                            have quality of life and dignity.
                             ...
                             eKalakaar.com promotes the traditional performing art by democratising the art, wherein the artists
                             have quality of life and dignity.
                             Partners to an artist can include a variety of people, such as agents, managers, publicists, lawyers,
                             and other professionals who help the artist with their career. 
                             They can also include other artists, such as collaborators or co-writers.
                             Partners in a collaboration project could include musicians, visual artists, writers, dancers, filmmakers, actors, and other creative professionals. It could also include organizations such as record labels,
                              production companies, galleries, and performance venues.
                              
Partners can reach an artist by attending music industry events, networking with other
 industry professionals, and connecting with the artist's team. They can also reach out to the artist directly through social media, email, or other contact methods. Additionally, they can contact the artist's label 
or management company to inquire about potential partnerships.
                ...
                <div class="row mt-5 text">
                    <h2 class="text-danger text-center h2"><strong>How Partners help Artsits</strong></h2>
                    <p class="h5" >
                    Partners can help artists in a variety of ways. They can provide financial support, marketing and
                     promotion, legal advice, and access to resources and networks. Partners can also provide mentorship 
                     and guidance, helping the artist to develop their craft and career. Additionally, partners
                     can offer emotional support, helping the artist to stay motivated and focused on their goals.
                
Partners can provide resources to artists in a variety of ways. They can offer access to their networks of 
contacts, provide financial resources, help with marketing and promotion, offer advice and mentorship,
 provide access to studio space, and provide resources such as equipment and materials. Partners can 
 also provide access to industry professionals and resources, such as booking agents, music producers,
  and legal advisors. Additionally, partners 
can provide access to resources such as grants, funding, and other forms of financial assistance.
                   </p>

                   <p class="h5">
                    
Partners can support artists in a variety of ways. They can provide
 financial support, such as grants or investments, to help the artist develop their career. They can also offer marketing and promotional support, such as creating a website or social media presence, to help the artist reach a wider audience. Partners can also provide mentorship and advice, helping the artist to develop their skills and reach their goals. Finally, partners can provide access
 to resources, such as studio space or equipment, to help the artist create their work.
                   </p>
                ...
                <div class="row mt-4 text-center">
                    ...
                    <ul class="text-start h5" tyle={{"text-decoration": "none" ,"margin-left": "20px"}}>
