    ...
    <div className="rate-patron-body container">
      <form action="#" onsubmit="return(validateRatePatron());">
        <div className="rate-patron-body-patron-rating">
          <div className="row">
            <label htmlFor="staticEmail" className="col-sm-2 col-form-label rate-patron-body-patron-rating-text">Rating:</label>
            <div className="col-sm-10">
              <fieldset className="rate-patron-body-patron-rating-fieldset">
                <span className="star-cb-group">
                  ...
                  <label htmlFor="rating-5" style={{fontSize: 26}}>5</label>
                  <input type="radio" id="rating-4" name="rating" defaultValue={4} />
                  <label htmlFor="rating-4" style={{fontSize: 26}}>4</label>
                  <input type="radio" id="rating-3" name="rating" defaultValue={3} />
                  <label htmlFor="rating-3" style={{fontSize: 26}}>3</label>
                  <input type="radio" id="rating-2" name="rating" defaultValue={2} />
                  <label htmlFor="rating-2" style={{fontSize: 26}}>2</label>
                  <input type="radio" id="rating-1" name="rating" defaultValue={1} />
                  <label htmlFor="rating-1" style={{fontSize: 26}}>1</label>
                </span>
              </fieldset>
            </div>
            <div className="w-100" />
            <div className="col-sm-10 rate-patron-body-patron-rating-number">
            </div>
          </div>
        </div>
        <div className="rate-patron-body-patron-feedback">
          <div className="mb-3">
            <label htmlFor="feedback" className="form-label rate-patron-body-patron-feedback-text">Feedback:</label>
            <textarea className="form-control" id="feedback" rows={5} defaultValue={""} />
          </div>
        </div>
        <div className="d-grid gap-1 d-md-flex justify-content-center edit-patron-profile-save-changes">
          <button className="btn btn-danger me-md-2 btn-new" style={{ marginTop:"10px"}} type="submit" value="Submit">
            Submit
          </button>
        </div>
      </form>
