                ...
                <div style={{borderWidth:"1px"}} className="card artist-details-card">
                    <div style={{marginLeft:"10px"}} className="card-body">
                        ...
                        <div className="d-grid gap-1 d-md-flex justify-content-center edit-patron-profile-save-changes">
                           ...
                           <Link to="/View_contacted_artist">     Hire Kalakaar</Link>
                            </button>
                            <button className="btn_shortlist  btn-warning">
                            <Link to="/view_shortlisted_artist">    shortlist Kalakaar</Link>
                            </button>
                            <button className="btn_remove">
                            <Link to="/Applied_artist_application">    Remove Kalakaar</Link>
                            </button>
                        </div>
                    </div>
                </div>
